...
class ConditionalVAESP(nn.Module):
    ...
    def loss_function(self, recons, input, mu0, log_var0, mu1, log_var1, mu2, log_var2):
        ...
        kld_weight = 10  # Account for the minibatch samples from the dataset
        ...
        return {'loss': loss, 'Reconstruction_Loss':recons_loss, 'KLD':-kld_weight * (kld_weight0 * kld_loss0 + kld_weight1 * kld_loss1 + kld_weight2 * kld_loss2)}
