...
#BSUB -o SNcwganScript%J.out
#BSUB -e SNcwganScript%J.err
# -- end of LSF options --
nvidia-smi
...
python -u -m torch.distributed.launch --use-env Model/GAN/SNcwganScript.py --multigpu --gpu_id 0,1 --batch_size 64 --loadmodel
