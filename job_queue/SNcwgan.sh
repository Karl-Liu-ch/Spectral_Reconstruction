...
# python -u -m torch.distributed.launch --use-env Models/GAN/SNcwgan.py --multigpu --loadmodel --batch_size 128 --gpu_id 0,1
python -u Models/GAN/SNcwgan.py --batch_size 256 --gpu_id 0
